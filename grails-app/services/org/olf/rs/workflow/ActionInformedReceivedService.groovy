...
@Slf4j
@Transactional
class ActionInformedReceivedService extends AbstractAction {

	/** Returns the action that this class represents */
	@Override
	String getActionCode() {
		return(Action.INFORMED_RECEIVED);
	}
	...
	ActionResponse perform(PatronRequest requestToBeProcessed) {
		...
		log.debug("ActionInformedReceivedService::perform(${requestToBeProcessed})");
