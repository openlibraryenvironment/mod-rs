...
class StateModel implements MultiTenant<StateModel> {
    ...
    public static final String MODEL_SLNP_NON_RETURNABLE_REQUESTER = 'SLNPNonReturnableRequester';
    ...
    public static final String MODEL_SLNP_NON_RETURNABLE_RESPONDER = 'SLNPNonReturnableResponder';
