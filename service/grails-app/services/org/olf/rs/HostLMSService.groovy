...
public class HostLMSService {
  ...
  public HostLMSActions getHostLMSActionsFor(String lms) {
    ...
    if ( result == null ) {
      log.warn("Unable to locate HostLMSActions for ${lms}. Did you fail to configure the app_setting \"host_lms_integration\". Current options are aleph|alma|FOLIO|Koha|Millennium|Sierra|Symphony|Voyager|wms|manual|default|Polaris");
    }
