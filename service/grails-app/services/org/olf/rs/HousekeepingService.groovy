  ...
  private void setupData(tenantName, tenantId) {
    ...
    Tenants.withId(tenantId) {
      Status.withNewTransaction { status ->
        ...
        def alc = Counter.findByContext('/activeBorrowing') ?: new Counter(context:'/activeBorrowing', value:0, description:'Current (Aggregate) Borrowing Level').save(flush:true, failOnError:true)
      }
