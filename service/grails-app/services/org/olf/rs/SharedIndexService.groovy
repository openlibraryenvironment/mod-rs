...
public class SharedIndexService {
  ...
  public SharedIndexActions getSharedIndexActionsFor(String si) {
    ...
    // SharedIndexActions result = grailsApplication.mainContext."FolioSharedIndexService"
    SharedIndexActions result = folioSharedIndexService;
  ...
  public SharedIndexActions getSharedIndexActions() {
    ...
    // String v = host_si_intergation_setting?.value;
    String v = "Folio";
