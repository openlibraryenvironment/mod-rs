...
public class GraphVizBuilder {
     ...
     */
    static void generateGraph(String stateModelCode, List<AbstractAction> actions, List<AbstractEvent> events, OutputStream outputStream, int height = 0) {
        ...
        events.each { event ->
            ...
            if ((fromStates == null) || (fromStates.size() == 0)) {
                fromStates = DEFAULT_EVENT_TO_FROM_STATES;
            }
            if ((toStates == null) || (toStates.size() == 0)) {
                toStates = DEFAULT_EVENT_TO_FROM_STATES;
            }
