...
class RSLifecycleSpec extends TestBase {
    ...
    void "test scenarios"(
        ...
        "RSInstOne"       | "RSInstThree"     | 9        | true              | "nrRequesterCancel.json"            | Status.PATRON_REQUEST_CANCEL_PENDING              | Status.RESPONDER_CANCEL_REQUEST_RECEIVED    | null               | null                  | "URL"          | "Copy"      | "{status=true}"        | null
