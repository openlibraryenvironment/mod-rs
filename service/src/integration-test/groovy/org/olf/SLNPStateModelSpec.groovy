...
class SLNPStateModelSpec extends TestBase {
    ...
    void "Test initial state transition to result state by performed action"(
        ...
        'RSSlnpOne'   | 'respond19'   | 'test19'      | '1234-5678-9123-1251' | '9876-1251'       | 'ISIL:RSS1'   | 'SLNP_RES_AWAIT_SHIP'               | 'SLNP_RES_AWAIT_SHIP'                | Actions.ACTION_RESPONDER_SUPPLIER_CONDITIONAL_SUPPLY         | 'supplierConditionalSupply'      | false
        'RSSlnpThree' | 'respond20'   | 'test20'      | '1234-5678-9123-1252' | '9876-4444'       | 'ISIL:RSS3'   | 'SLNP_RES_ITEM_SHIPPED'             | 'SLNP_RES_COMPLETE'                  | Actions.ACTION_RESPONDER_SUPPLIER_CHECKOUT_OF_RESHARE        | 'supplierCheckOutOfReshare'      | false
    }
