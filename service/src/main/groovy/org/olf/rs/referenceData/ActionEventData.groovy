...
public class ActionEventData {
	...
	public void load() {
        ...
        ActionEvent.ensure(Events.EVENT_STATUS_REQ_EXPECTS_TO_SUPPLY, 'Status has changed to Expected to Supply', false, eventServiceName(Events.EVENT_STATUS_REQ_EXPECTS_TO_SUPPLY), ActionEventResultList.REQUESTER_NO_STATUS_CHANGE);
