...
public class ActionEventData {
	...
	public void load() {
        ...
        ActionEvent.ensure(Actions.ACTION_RESPONDER_ITEM_RETURNED, 'The responder has received the returned item(s)', true, StateModel.MODEL_RESPONDER.capitalize() + Actions.ACTION_RESPONDER_ITEM_RETURNED.capitalize(), null);
        ...
        ActionEvent.ensure(Actions.ACTION_RESPONDER_SUPPLIER_CANNOT_SUPPLY, 'The responder is saying they cannot supply the item(s)', true, StateModel.MODEL_RESPONDER.capitalize() + Actions.ACTION_RESPONDER_SUPPLIER_CANNOT_SUPPLY.capitalize(), ActionEventResultList.RESPONDER_CANNOT_SUPPLY);
        ...
        ActionEvent.ensure(Actions.ACTION_RESPONDER_SUPPLIER_CHECKOUT_OF_RESHARE, 'The item(s) has been checked backed into the responders LMS from Reshare', true, StateModel.MODEL_RESPONDER.capitalize() + Actions.ACTION_RESPONDER_SUPPLIER_CHECKOUT_OF_RESHARE.capitalize(), ActionEventResultList.RESPONDER_ITEM_RETURNED);
        ...
        ActionEvent.ensure(Actions.ACTION_RESPONDER_SUPPLIER_MARK_SHIPPED, 'The responder has shipped the item(s) to the requester', true, StateModel.MODEL_RESPONDER.capitalize() + Actions.ACTION_RESPONDER_SUPPLIER_MARK_SHIPPED.capitalize(), ActionEventResultList.RESPONDER_MARK_SHIPPED);
        ...
        // Requester Actions
        ActionEvent.ensure(Actions.ACTION_REQUESTER_BORROWER_CHECK, 'Check that the borrower id is valid and they are able to request an item', true, StateModel.MODEL_REQUESTER.capitalize() + Actions.ACTION_REQUESTER_BORROWER_CHECK.capitalize(), ActionEventResultList.REQUESTER_BORROWER_CHECK);
        ActionEvent.ensure(Actions.ACTION_REQUESTER_BORROWER_CHECK_OVERRIDE, 'Check that the borrower id is valid and they are able to request an item, if they are not valid or cannot request an item the librarian can override this to say they are', true, StateModel.MODEL_REQUESTER.capitalize() + Actions.ACTION_REQUESTER_BORROWER_CHECK_OVERRIDE.capitalize(), ActionEventResultList.REQUESTER_BORROWER_CHECK);
        ...
        ActionEvent.ensure(Actions.ACTION_REQUESTER_PATRON_RETURNED_ITEM, 'The patron has returned the item(s) to the requesting libarary', true, StateModel.MODEL_REQUESTER.capitalize() + Actions.ACTION_REQUESTER_PATRON_RETURNED_ITEM.capitalize(), ActionEventResultList.REQUESTER_PATRON_RETURNED);
        ...
        ActionEvent.ensure(Actions.ACTION_REQUESTER_REQUESTER_AGREE_CONDITIONS, 'The requester has agreed to the conditions imposed by the responder', true, StateModel.MODEL_REQUESTER.capitalize() + Actions.ACTION_REQUESTER_REQUESTER_AGREE_CONDITIONS.capitalize(), ActionEventResultList.REQUESTER_AGREE_CONDITIONS);
        ...
        ActionEvent.ensure(Actions.ACTION_REQUESTER_REQUESTER_RECEIVED, 'The requester has received the item(s) from the responder', true, StateModel.MODEL_REQUESTER.capitalize() + Actions.ACTION_REQUESTER_REQUESTER_RECEIVED.capitalize(), ActionEventResultList.REQUESTER_RECEIVED);
        ActionEvent.ensure(Actions.ACTION_REQUESTER_REQUESTER_REJECT_CONDITIONS, 'The requester has rejected the conditions imposed by the responder', true, StateModel.MODEL_REQUESTER.capitalize() + Actions.ACTION_REQUESTER_REQUESTER_REJECT_CONDITIONS.capitalize(), ActionEventResultList.REQUESTER_REJECT_CONDITIONS);
        ActionEvent.ensure(Actions.ACTION_REQUESTER_SHIPPED_RETURN, 'The requester has returned the item(s) to the responder', true, StateModel.MODEL_REQUESTER.capitalize() + Actions.ACTION_REQUESTER_SHIPPED_RETURN.capitalize(), ActionEventResultList.REQUESTER_SHIPPED_RETURN);
