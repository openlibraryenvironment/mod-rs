...
public class SLNPStateModelData {
    ...
    public static void loadAvailableActionData() {
        ...
        AvailableAction.ensure(StateModel.MODEL_SLNP_REQUESTER, Status.SLNP_REQUESTER_IDLE, Actions.ACTION_REQUESTER_CANCEL_LOCAL, AvailableAction.TRIGGER_TYPE_MANUAL, ActionEventResultList.SLNP_REQUESTER_CANCEL, null, Boolean.FALSE, Boolean.FALSE)
