...
public class SettingsData {
    ...
    public static final String SETTING_DISABLE_CREATE_BUTTON = 'disable_create_button';
    ...
    public void load() {
        try {
            ...
            ensureAppSetting(SETTING_DISABLE_CREATE_BUTTON, SECTION_OTHER, SETTING_TYPE_REF_DATA, RefdataValueData.VOCABULARY_YES_NO, null, referenceDataService.lookup(RefdataValueData.VOCABULARY_YES_NO, RefdataValueData.YES_NO_NO).value);
