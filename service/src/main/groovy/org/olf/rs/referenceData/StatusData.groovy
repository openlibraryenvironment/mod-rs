...
public class StatusData {
  ...
  public static final Map<String, String> tags = [
	...
	public void load() {
        ...
        Status.ensure(Status.PATRON_REQUEST_SUPPLIER_IDENTIFIED, StatusStage.PREPARING, '0020', true, null, false, null, [ tags.ACTIVE_PATRON ]);
        Status.ensure(Status.PATRON_REQUEST_REQUEST_SENT_TO_SUPPLIER, StatusStage.ACTIVE, '0025', true, null, false, null, [ tags.ACTIVE_PATRON ]);
        Status.ensure(Status.PATRON_REQUEST_CONDITIONAL_ANSWER_RECEIVED, StatusStage.ACTIVE, '0026', true, true, false, null, [ tags.ACTIVE_PATRON ]);
        Status.ensure(Status.PATRON_REQUEST_CANCEL_PENDING, StatusStage.ACTIVE, '0027', true, null, false, null, [ tags.ACTIVE_PATRON ]);
        ...
        Status.ensure(Status.PATRON_REQUEST_OVER_LIMIT, StatusStage.COMPLETED, '0084', true, null, true, 3);
        ...
        Status.ensure(Status.RESPONDER_AWAIT_SHIP, StatusStage.ACTIVE, '0021', true, null, false, null, [ tags.ACTIVE_LOAN ]);
        ...
        Status.ensure(Status.RESPONDER_ITEM_SHIPPED, StatusStage.ACTIVE_SHIPPED, '0040', true, null, false, null, [ tags.ACTIVE_LOAN ]);
        Status.ensure(Status.RESPONDER_ITEM_RETURNED, StatusStage.ACTIVE_SHIPPED, '0040', true, null, false, null, [ tags.ACTIVE_LOAN ]);
        ...
        Status.ensure(Status.RESPONDER_OVERDUE, StatusStage.ACTIVE_SHIPPED, '9997', true, null, false, null, [ tags.ACTIVE_LOAN ]);
