...
public class Events {
	...
	static public final String EVENT_SLNP_REQUESTER_ISO_18626_ABORTED_INDICATION      = STATUS_EVENT_PREFIX + Status.SLNP_REQUESTER_ABORTED + STATUS_EVENT_POSTFIX;
	static public final String EVENT_SLNP_REQUESTER_ISO_18626_SHIPPED_INDICATION      = STATUS_EVENT_PREFIX + Status.SLNP_REQUESTER_SHIPPED + STATUS_EVENT_POSTFIX;
}
